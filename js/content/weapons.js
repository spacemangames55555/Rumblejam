...
export const WEAPONS = [
  ...
  { id: 'vaultspike', name: 'Vaultspike', cls: 'thrust', sym: '☨', color: '#ffd45e',
    dmg: 9, cd: 0.65, range: 120, knock: 50, thrustW: 20, critBonus: 20,
  ...
  { id: 'pebbleshot', name: 'Pebbleshot', cls: 'single', sym: '•', color: '#c8cde8',
    dmg: 8, cd: 0.7, range: 420, knock: 30, projSpeed: 620, pierce: 0,
  ...
  { id: 'coilgun', name: 'Coilgun', cls: 'single', sym: '≡', color: '#4fd8eb',
    dmg: 18, cd: 1.4, range: 560, knock: 60, projSpeed: 1100, pierce: 99,
  ...
  { id: 'hailburst', name: 'Hailburst', cls: 'spread', sym: '᎒᎒', color: '#5ea8ff',
    dmg: 4, cd: 0.9, range: 260, knock: 20, projSpeed: 600, pierce: 0, count: 8, spreadDeg: 55,
  ...
  { id: 'kegbomb', name: 'Kegbomb', cls: 'lobbed', sym: '●', color: '#ffab4f',
    dmg: 24, cd: 2.0, range: 420, knock: 180, projSpeed: 420, aoe: 110,
