...
export const BOSSES = [
  { id: 'ossuary_hulk', name: 'The Ossuary Hulk', kit: 'hulk', floor: 1,
    hp: 620, dmg: 10, spd: 62, radius: 46, shape: 'square', color: '#c05e4c', mats: 30,
  ...
  { id: 'choir_of_eyes', name: 'Choir of Eyes', kit: 'choir', floor: 2,
    hp: 900, dmg: 10, spd: 85, radius: 40, shape: 'pentagon', color: '#a86ae8', mats: 36,
  ...
  { id: 'broodmother_viv', name: 'Broodmother Viv', kit: 'brood', floor: 3,
    hp: 1350, dmg: 12, spd: 70, radius: 44, shape: 'star', color: '#c98b4f', mats: 42,
  ...
  { id: 'vault_regent', name: 'The Vault Regent', kit: 'regent', floor: 4,
    hp: 2000, dmg: 15, spd: 78, radius: 48, shape: 'hex', color: '#ffd45e', mats: 60,
