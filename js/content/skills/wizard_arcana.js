...
export const WIZARD_ARCANA = [
  {
    ...
    flavor: 'A gout of flame at the nearest thing.',
  ...
  {
    id: 'wiz_mind_spike', tree: 'wizard_arcana', tier: 4, name: 'Mind Spike',
    flavor: 'Finds the weakest thing in range and finishes it.',
  ...
  },
  {
    ...
    flavor: 'The floor burns where the crowd is thickest.',
    type: 'active', domain: 'physical', prereq: 'wiz_frost_nail',
  ...
  },
  {
    ...
    id: 'wiz_arcane_recovery', tree: 'wizard_arcana', tier: 6, name: 'Arcane Recovery',
  ...
  },
  {
    ...
    flavor: 'A close arc that cracks armour.',
    type: 'active', domain: 'mental', prereq: 'wiz_mind_spike',
    select: 'highest_hp',
  ...
  {
    id: 'wiz_ley_surge', tree: 'wizard_arcana', tier: 10, name: 'Ley Surge',
    flavor: 'A wave of spirit through the crowd.',
  ...
  {
    id: 'wiz_starfall', tree: 'wizard_arcana', tier: 8, name: 'Starfall',
    flavor: 'Three falling motes, each leaving a burn.',
  ...
  },
  {
    ...
    flavor: 'The answer, written across the room.',
