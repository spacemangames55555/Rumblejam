// The CLASSIC roster — 33 characters (the Great Rebalance + Pulsar). Each is a
// stat spread + starting weapon + one signature trait (engine-implemented via
...
//
// This file is FROZEN content. `characters.js` picks between this roster and
// the Thrones of Heaven roster at runtime; nothing here changes when a second
// roster ships, and `roster-33-final` pins the behaviour this file must keep.

export const CHARACTERS_CLASSIC = [
