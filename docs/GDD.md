...
Any active is data: an ordered list of steps from **fifteen** primitives plus riders.

**Primitives:** `strike` · `bolt` · `cone` · `line` · `hazard` · `gravity_pull` · `heal` · `shield` · `ward` · `drain` · `summon` · `plague` · `shift` · `trap` · `form`
