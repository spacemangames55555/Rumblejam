...
Any active is data: an ordered list of steps from **sixteen** primitives plus riders.

**Primitives:** `strike` · `bolt` · `cone` · `line` · `hazard` · `gravity_pull` · `channel` · `heal` · `shield` · `ward` · `drain` · `summon` · `plague` · `shift` · `trap` · `form`
